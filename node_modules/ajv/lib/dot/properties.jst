  ...
  {{~ $pgPropertyKeys:$pgProperty }}
    ...
    {{? {{# def.nonEmptySchema:$sch}} }}
      ...
      {{? $pgMin !== undefined || $pgMax !== undefined }}
        ...
        {{? $pgMin !== undefined }}
          {{ var $yimit = $pgMin, $reason = 'minimum', $moreOrLess = 'less'; }}
          {{=$valid}} = pgPropCount{{=$yvl}} >= {{=$pgMin}};
        ...
        {{? $pgMax !== undefined }}
          {{ var $yimit = $pgMax, $reason = 'maximum', $moreOrLess = 'more'; }}
          {{=$valid}} = pgPropCount{{=$yvl}} <= {{=$pgMax}};
