...
{{## def._errorMessages = {
  ...
  patternGroups:   "'should NOT have {{=$moreOrLess}} than {{=$yimit}} properties matching pattern \"{{=it.util.escapeQuotes($pgProperty)}}\"'",
...
{{## def._errorParams = {
  ...
  patternGroups:   "{ reason: '{{=$reason}}', limit: {{=$yimit}}, pattern: '{{=it.util.escapeQuotes($pgProperty)}}' }",
